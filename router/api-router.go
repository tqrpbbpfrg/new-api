...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		// Public concise options (typed) for frontend runtime feature toggles & UI decisions
		apiRouter.GET("/options", controller.GetPublicOptions)
		...
		redemptionRoute.Use(middleware.AdminAuth())
		{
			...
			redemptionRoute.POST("/batch/delete_by_names", controller.BatchDeleteRedemptionByNames)
