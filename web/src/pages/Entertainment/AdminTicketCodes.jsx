...
export default function AdminTicketCodes(){
  ...
  return <div className='p-4'>
    <Card title={t('抽奖券兑换码')} extra={<Space><Button type='primary' onClick={()=>{formApi && formApi.reset(); setVisible(true);}}>{t('新增')}</Button></Space>} loading={loading}>
    ...
    <Modal title={t('生成兑换码')} visible={visible} onCancel={()=>setVisible(false)} onOk={()=>formApi && formApi.submit()}>
      <Form getFormApi={setFormApi} onSubmit={createCodes} labelPosition='inset'>
